...
class LaravelSearch extends SearchBuilder {
	...
	protected function limit() {
		// TODO Auto-generated method stub
		$this->model->take($this->options['limit'][1])->skip($this->options['limit'][0]);
	...
	protected function field() {
		// TODO Auto-generated method stub
		$this->model->select($this->options['field']);
	...
	protected function order() {
		// TODO Auto-generated method stub
		$this->model->orderBy($this->options['order'][0],$this->options['order'][1]);
